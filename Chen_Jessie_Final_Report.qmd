...
Overall, it does seem worthwhile to build more complex models since the non-parametric models (random forest, boosted tree, k nearest neighbors) generally performed better than the parametric models. However, my feature-engineered recipe generally create worse-performing models than the baseline kitchen sink recipe.
